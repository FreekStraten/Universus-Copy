            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-white">
                        <form wire:submit.prevent="createCategory" class="max-w-md mx-auto">
                            <div class="mb-4">
                            ...
                            <div class="flex items-center justify-center">
                                <button id="submit" dusk="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                    {{ __('Category.Submit') }}
                                </button>
                            </div>
                        </form>
